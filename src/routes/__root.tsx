...
function RootLayout() {
  ...
  const isFileManagerRoute =
    pathname === '/file-manager' || pathname.startsWith('/file-manager/')
        ...
        <script
          ...
          (function(){
            ...
            d.innerHTML = '<img src="/claude-avatar.webp" alt="Hermes Agent" style="width:80px;height:80px;margin-bottom:20px;border-radius:16px;filter:drop-shadow(0 8px 32px color-mix(in srgb,'+accent+' 45%, transparent))" />'
              + '<div style="font:700 26px/1 Inter,system-ui,-apple-system,sans-serif;letter-spacing:0.08em;color:'+txt+';margin-bottom:8px">LAM CYBERLAB</div>'
