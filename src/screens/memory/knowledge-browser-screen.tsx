...
export function KnowledgeBrowserScreen() {
  ...
  useEffect(() => {
    if (selectedPath) {
      const el = document.getElementById(
        `kb-sidebar-item-${encodeURIComponent(selectedPath)}`,
      )
      if (el) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-surface text-ink overflow-y-auto md:overflow-hidden">
      <div className="mx-auto flex h-full w-full max-w-[1200px] md:min-h-0 flex-1 flex-col px-4 py-6 sm:px-6 lg:px-8">
        <div
