  ...
  const steps = [
    {
      ...
      body: 'Install Tailscale on the machine running Lam Cyberlab, then sign in.',
    ...
    },
    {
      ...
      body: 'Lam Cyberlab can talk to any OpenAI-compatible backend on mobile too. Make sure both the workspace and backend stay reachable over Tailscale or your local network.',
    ...
    {
      title: 'Open Lam Cyberlab on your phone',
      body:
