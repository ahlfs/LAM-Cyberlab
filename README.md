...
**Personal AI agent command center — chat, files, memory, skills, terminal, and system monitoring in one place.**

[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Node](https://img.shields.io/badge/node-%3E%3D22.0.0-brightgreen.svg)](https://nodejs.org/)

> **Attribution / Atribusi.** Lam Cyberlab is a personal modification of
...
> and personal workflow docs — see [docs/PRD-workspace-additions.md](docs/PRD-workspace-additions.md).
...
Lam Cyberlab works with any OpenAI-compatible backend. If your backend also exposes Hermes Agent gateway APIs, enhanced features like sessions, memory, skills, and jobs unlock automatically.
...
Point Lam Cyberlab at any backend that supports:
...
### Step 2: Install & Run Lam Cyberlab
...
Download [Atomic Chat](https://atomic.chat/), launch the desktop app, and make sure a model is loaded before starting Lam Cyberlab.
...
If you use Lam Cyberlab from Windows with the agent running in WSL, use the helper script in this repo:
...
The Docker setup runs both the **Hermes Agent gateway** and **Lam Cyberlab** together.
...
Deploying Lam Cyberlab to a PaaS or home-lab stack? Pull the image
...
Lam Cyberlab is a **Progressive Web App (PWA)** — install it for the full native app experience with no browser chrome, keyboard shortcuts, and offline support.
...
4. Tap **Add** — the Lam Cyberlab icon appears on your home screen
...
3. Tap **Add** — Lam Cyberlab is now a native-feeling app on your device
...
4. **Open Lam Cyberlab on your phone:**
...
**In the meantime:** Install Lam Cyberlab as a PWA (see above) for a near-native desktop experience — it works great.
...
A fully managed cloud version of Lam Cyberlab is in development:
...
Lam Cyberlab is free and open source. If it's saving you time and powering your workflow, consider supporting development:
...
<div align="center">
  <sub>Built with ⚡ by <a href="https://github.com/outsourc-e">@outsourc-e</a> and the Lam Cyberlab community</sub>
</div>
