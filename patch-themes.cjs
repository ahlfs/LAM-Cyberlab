...
css = css.replace(
  "[data-theme='discord-nitro'] html,",
  darkSelectors + "[data-theme='discord-nitro'] html,",
)

const lightSelectors =
  "[data-theme='matrix-light'] html,\\n" +
...
css = css.replace(
  "[data-theme='discord-nitro-light'] html,",
  lightSelectors + "[data-theme='discord-nitro-light'] html,",
)
...
css = css.replace(
  "[data-theme='discord-nitro'] {\\n  --color-primary-50",
  darkRemap + "[data-theme='discord-nitro'] {\\n  --color-primary-50",
)
...
css = css.replace(
  "[data-theme='discord-nitro-light'] {\\n  color-scheme:",
  lightRemap + "[data-theme='discord-nitro-light'] {\\n  color-scheme:",
)
